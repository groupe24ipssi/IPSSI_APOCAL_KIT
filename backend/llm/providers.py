...
PROVIDERS: dict[str, Provider] = {
    "ollama": Provider(
        key="ollama", label="Ollama (local)", cloud=False, paid=False, needs_key=False,
        settings_model_attr="OLLAMA_MODEL", settings_key_attr="", default_model="llama3.1:8b",
    ...
    "gemini": Provider(
        key="gemini", label="Google Gemini", cloud=True, paid=False, needs_key=True,
        settings_model_attr="GEMINI_MODEL", settings_key_attr="GEMINI_API_KEY",
    ...
    "groq": Provider(
        key="groq", label="Groq", cloud=True, paid=False, needs_key=True,
        settings_model_attr="GROQ_MODEL", settings_key_attr="GROQ_API_KEY",
        default_model="llama-3.3-70b-versatile",
        help="Cloud très rapide (LPU), free tier généreux, modèles open-source.",
        keys_url="https://console.groq.com/keys",
    ),
    "cerebras": Provider(
        key="cerebras", label="Cerebras Cloud", cloud=True, paid=False, needs_key=True,
        settings_model_attr="CEREBRAS_MODEL", settings_key_attr="CEREBRAS_API_KEY",
        default_model="llama-3.3-70b",
        help="Cloud très rapide, free tier disponible.",
        keys_url="https://cloud.cerebras.ai/",
    ),
    "mistral": Provider(
        key="mistral", label="Mistral AI", cloud=True, paid=False, needs_key=True,
        settings_model_attr="MISTRAL_MODEL", settings_key_attr="MISTRAL_API_KEY",
        default_model="mistral-small-latest",
        help="Fournisseur EUROPÉEN (données en UE — meilleur pour le RGPD), free tier.",
        keys_url="https://console.mistral.ai/",
    ),
    "openrouter": Provider(
        key="openrouter", label="OpenRouter", cloud=True, paid=False, needs_key=True,
        settings_model_attr="OPENROUTER_MODEL", settings_key_attr="OPENROUTER_API_KEY",
    ...
    "openai": Provider(
        key="openai", label="OpenAI", cloud=True, paid=True, needs_key=True,
        settings_model_attr="OPENAI_MODEL", settings_key_attr="OPENAI_API_KEY",
    ...
    "anthropic": Provider(
        key="anthropic", label="Anthropic (Claude)", cloud=True, paid=True, needs_key=True,
        settings_model_attr="ANTHROPIC_MODEL", settings_key_attr="ANTHROPIC_API_KEY",
        default_model="claude-3-5-haiku-20241022",
        help="Cloud PAYANT (crédit requis). Réservé à une future version « premium ».",
        keys_url="https://console.anthropic.com/settings/keys",
    ),
    "mock": Provider(
        key="mock", label="Mock (faux quiz)", cloud=False, paid=False, needs_key=False,
        settings_model_attr="", settings_key_attr="", default_model="—",
