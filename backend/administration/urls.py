...
from .views import (AdminResetDataView, AdminSeedView, AdminStatsView,
                    AdminUserDetailView, AdminUserListView,
                    AdminUserResendVerificationView, LLMConfigAdminView,
                    SiteConfigAdminView)
...
urlpatterns = [
    ...
    path("users/<int:pk>/resend-verification/",
         AdminUserResendVerificationView.as_view(), name="admin-user-resend"),
